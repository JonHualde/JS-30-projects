...
console.log(fullNames, "Names concatenated");
...
console.log(totalYears, "Total years lived by all inventors");

// 5. Sort the inventors by years lived
const sortedInventor = inventors.sort(
...
console.table(numberOfInstances);
